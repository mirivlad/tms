    ...
    public function save(ServerRequestInterface $request, ResponseInterface $response): ResponseInterface
    {
        ...
        try {
            $this->settings->saveForUser($this->userId(), [
                ...
                'notify_task_assignments' => $this->checked($body, 'notify_task_assignments'),
                'notify_task_dates' => $this->checked($body, 'notify_task_dates'),
                'notify_task_status' => $this->checked($body, 'notify_task_status'),
