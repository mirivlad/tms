...
use Tms\Http\Controller\ProjectAttachmentController;
use Tms\Http\Controller\ProjectCustomFieldController;
...
final class ApplicationFactory
{
    public function run(): void
    {
        ...
        $discussions = new DiscussionRepository($db);
        ...
        $projectController = new ProjectController($twig, $sessions, $projects, $projectAttachments, $attachmentStorage, $tasks, $projectStatuses, $projectCustomFields, $teams, $discussions, $translator);
        ...
        $app->post('/projects/{projectId:[0-9]+}/statuses', [$projectStatusController, 'create'])->add($requireAuth);
        $app->post('/projects/{projectId:[0-9]+}/statuses/{statusId:[0-9]+}', [$projectStatusController, 'update'])->add($requireAuth);
        $app->post('/projects/{projectId:[0-9]+}/statuses/{statusId:[0-9]+}/default', [$projectStatusController, 'setDefault'])->add($requireAuth);
        $app->post('/projects/{projectId:[0-9]+}/statuses/{statusId:[0-9]+}/completion', [$projectStatusController, 'setCompletion'])->add($requireAuth);
        $app->post('/projects/{projectId:[0-9]+}/statuses/{statusId:[0-9]+}/move', [$projectStatusController, 'move'])->add($requireAuth);
        $app->post('/projects/{projectId:[0-9]+}/statuses/{statusId:[0-9]+}/delete', [$projectStatusController, 'delete'])->add($requireAuth);
        $app->post('/projects/{projectId:[0-9]+}/fields', [$projectCustomFieldController, 'create'])->add($requireAuth);
        $app->post('/projects/{projectId:[0-9]+}/fields/{fieldId:[0-9]+}', [$projectCustomFieldController, 'update'])->add($requireAuth);
        $app->post('/projects/{projectId:[0-9]+}/fields/{fieldId:[0-9]+}/move', [$projectCustomFieldController, 'move'])->add($requireAuth);
        $app->post('/projects/{projectId:[0-9]+}/fields/{fieldId:[0-9]+}/delete', [$projectCustomFieldController, 'delete'])->add($requireAuth);
        $app->post('/projects/{projectId:[0-9]+}/attachments', [$projectAttachmentController, 'upload'])->add($requireAuth);
        $app->get('/projects/{projectId:[0-9]+}/attachments/{attachmentId:[0-9]+}', [$projectAttachmentController, 'download'])->add($requireAuth);
        $app->post('/projects/{projectId:[0-9]+}/attachments/{attachmentId:[0-9]+}/delete', [$projectAttachmentController, 'delete'])->add($requireAuth);
        $app->post('/projects/{projectId:[0-9]+}/discussion', [$discussionController, 'createProject'])->add($requireAuth);
        $app->post('/projects/{projectId:[0-9]+}/discussion/{commentId:[0-9]+}/reply', [$discussionController, 'replyProject'])->add($requireAuth);
        ...
        $app->post('/tasks/{taskId:[0-9]+}/discussion', [$discussionController, 'createTask'])->add($requireAuth);
        $app->post('/tasks/{taskId:[0-9]+}/discussion/{commentId:[0-9]+}/reply', [$discussionController, 'replyTask'])->add($requireAuth);
