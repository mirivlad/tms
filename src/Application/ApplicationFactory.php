...
final class ApplicationFactory
{
    public function run(): void
    {
        ...
        $projectController = new ProjectController($twig, $sessions, $projects, $projectAttachments, $attachmentStorage, $tasks, $projectStatuses, $translator);
        ...
        $taskController = new TaskController($twig, $sessions, $tasks, $attachments, $statuses, $taskTypes, $customers, $projects, $projectStatuses, $customFields, $customValues, $customValueCodec, $taskListSorter, $translator, $descriptionSanitizer);
