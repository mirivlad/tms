...
final class PasswordRecoveryServiceTest extends TestCase
{
    ...
    {
        $this->db->exec('CREATE TABLE users (id INTEGER PRIMARY KEY, username TEXT UNIQUE, email TEXT UNIQUE, password_hash TEXT, role TEXT, is_active INTEGER, email_verified_at TEXT NULL, approved_at TEXT, last_activity_at TEXT NULL, created_at TEXT DEFAULT CURRENT_TIMESTAMP, updated_at TEXT DEFAULT CURRENT_TIMESTAMP)');
        ...
        $this->db->exec("CREATE TABLE notification_settings (user_id INTEGER PRIMARY KEY, email_enabled INTEGER DEFAULT 0, email_address TEXT NULL, telegram_enabled INTEGER DEFAULT 0, telegram_chat_id TEXT NULL, telegram_username TEXT NULL,
            notify_task_assignments INTEGER NOT NULL DEFAULT 1,
            notify_task_dates INTEGER NOT NULL DEFAULT 1,
            notify_task_status INTEGER NOT NULL DEFAULT 0, notify_tomorrow INTEGER DEFAULT 0, tomorrow_time TEXT DEFAULT '08:00', notify_upcoming INTEGER DEFAULT 0, urgent_minutes INTEGER DEFAULT 15, high_minutes INTEGER DEFAULT 60, medium_minutes INTEGER DEFAULT 240, low_minutes INTEGER DEFAULT 1440, notify_overdue INTEGER DEFAULT 0, overdue_time TEXT DEFAULT '09:00', notify_digest INTEGER DEFAULT 0, digest_time TEXT DEFAULT '19:30')");
    }
}
