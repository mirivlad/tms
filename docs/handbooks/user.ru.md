...
<figure class="quick-figure">
  ...
  <figcaption>Настройки профиля — сначала проверьте часовой пояс и личные параметры.</figcaption>
</figure>
...
<figure class="quick-figure">
  ...
  <figcaption>В новой задаче плановое время и срок задаются отдельно.</figcaption>
</figure>
...
<figure class="interface-map-figure">
  ...
  <figcaption>Карта интерфейса на практике: основные разделы доступны из верхней навигации.</figcaption>
</figure>
...
Используйте этот раздел как справочник по поведению TMS: здесь собраны основные представления, правила работы с задачами, проектами, командами, обсуждениями и уведомлениями.
