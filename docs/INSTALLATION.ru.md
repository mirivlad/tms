...
Файл по умолчанию закреплён на `ghcr.io/mirivlad/tms:v0.1.3`. `TMS_IMAGE` нужен только если вы сознательно выбираете другую версию, `latest`, `edge` или неизменяемый `sha-*`.
